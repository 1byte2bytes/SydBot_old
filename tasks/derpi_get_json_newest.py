...
def do_task():
    urllib.request.urlretrieve("https://derpibooru.org/images.json?constraint=created&order=d", "./data/derpi_latest.json")
    images_to_grab = []
    with open("./data/derpi_latest.json") as data_file:
